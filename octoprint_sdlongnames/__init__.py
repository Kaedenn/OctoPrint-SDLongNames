...
class SDLongNamesPlugin(octoprint.plugin.SettingsPlugin,
    ...
    def get_assets(self):
        ...
        return {
            ...
            "css": ["css/sdlongnames.css"],
            "less": ["less/sdlongnames.less"]
        }
    ...
    def get_update_information(self):
        ...
        return {
            "sdlongnames": {
                ...
                # update method: pip
                "pip": "https://github.com/Kaedenn/OctoPrint-SDLongNames/archive/{target_version}.zip",
            }
        }
